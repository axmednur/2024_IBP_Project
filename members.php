<?php
  ...
  if(isset($_POST['submit'])){
     ...
     $sql = "INSERT INTO member (id, names, dates, dob, phone, coach) VALUES('$id','$names','$dates','$dob','$phone','$coach')";
...
<form action="Members.php"; method="POST">
  ...
  <div class="form-group">
    ...
    <input type="text" name="dates" class="form-control" id="inputAddress" placeholder="Date of joinig">
  </div>
  <div class="form-group">
